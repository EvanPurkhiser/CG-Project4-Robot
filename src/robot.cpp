...
void Robot::mainLoop()
{
	...
	glm::mat4 Model      = glm::mat4(55.0f);

	glm::mat4 RotateMatrix = glm::rotate(Model, rotation, glm::vec3(0, 0, 1));
	...
	MVP        = RotateMatrix * Projection * View * Model; // Remember, matrix multiplication is the other way around
